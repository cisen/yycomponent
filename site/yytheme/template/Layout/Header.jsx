...
export default class Header extends React.Component {
  ...
  render() {
    ...
    if (activeMenuItem === 'yycomponent') {
      activeMenuItem = 'docs/yycomponent';
    }
    ...
    const menu = [
      ...
      <Menu mode={menuMode} selectedKeys={[activeMenuItem]} id="nav" key="nav">
        ...
        <Menu.Item key="docs/yycomponent">
          <Link to={utils.getLocalizedPathname('/docs/yycomponent/getting-started', isZhCN)}>
            <FormattedMessage id="app.header.menu.yycomponent" />
          </Link>
        </Menu.Item>
